'use strict';
/**
 * PeopleSoft (Oracle Campus Solutions) detector - NOT IMPLEMENTED.
 *
...
module.exports = { platform: PLATFORM, implemented: false, status: 'planned', label: 'PeopleSoft (Oracle Campus Solutions)', detect };
